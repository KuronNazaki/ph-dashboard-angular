...
import { ZardIdDirective } from '@ph/core/directives/id-directive'
import { mergeClasses, noopFn } from '@ph/core/utils/merge-classes'
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => ZardCheckbox),
      multi: true,
    },
  ],
...
export class ZardCheckbox implements ControlValueAccessor {
